...
# -*- coding: utf-8 -*-
#
# aiohttp_mako documentation build configuration file, created by
...
project = 'aiohttp_mako'
copyright = '2015, Nikolay Novik and aio-libs team'
...
htmlhelp_basename = 'aiohttp_makodoc'
...
latex_documents = [
    ('index', 'aiohttp_jinja2.tex', 'aiohttp\\_jinja2 Documentation',
...
man_pages = [
    ('index', 'aiohttp_jinja2', 'aiohttp_jinja2 Documentation',
     ['Andrew Svetlov'], 1)
]
...
texinfo_documents = [
    ('index', 'aiohttp_jinja2', 'aiohttp_jinja2 Documentation',
     'Andrew Svetlov', 'aiohttp_jinja2', 'One line description of project.',
     'Miscellaneous'),
]
